...
function OrderHeaderForm({ sections = [], values = {}, onChange, onObjectSelect, addNewHandlers = {}, errors = {}, oldValues = {}, mode = '', menuId,  readOnly = false, }) {
      ...
      {sections.map((section, sectionIndex) => {
        ...
        return (
          <Fragment key={section.key || section.title || `section-${sectionIndex}`}>
            ...
            <div key={`section-${sectionIndex}`} className={`mb-1.5 ${SECTION_COLUMN_CLASS[section.columns] || SECTION_COLUMN_CLASS[2]}`}>
              {visibleFields.map((field) => {
                ...
                const resolvedField = {
                  ...
                  disabled: isDisabled,
                  readOnly: readOnly || isReadOnly || !canEditField,
                };
